...
const{name : city,
    ...
    timeDisplay.textContent = `Local Time: ${getLocalTime(timezone)}`;
...
function displayError(messsge){
    const errorDisplay = document.createElement("p");
    errorDisplay.textContent = messsge;
...
function getLocalTime(timezoneoffsetInSeconds){
    ...
    const localTime = new Date(utcMs+ timezoneoffsetInSeconds * 1000);
